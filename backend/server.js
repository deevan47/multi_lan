...
app.post("/api/submit", upload.none(), async (req, res) => {
  ...
  const values = [
    ...
    form.whatsapp || null,
    form.date,
    form.apartmentName || null,
    form.mapLink || null,
    form.unitsCount || null, 
    ...
    form.q2_3 || null,
    form.q2_4 || null,
    form.q2_5 !== undefined ? form.q2_5 : null,
    form.q2_6 || null,

    form.q3_1 || null,
    form.q3_2 || null,
    form.q3_3 !== undefined ? form.q3_3 : null,

    form.q4_1 || null,
    form.q4_2 || null,
    form.q4_3 !== undefined ? form.q4_3 : null,

    form.q5_1 || null,
    form.q5_2 || null,
    form.q5_3 || null,
    form.q5_4 !== undefined ? form.q5_4 : null,
  ];
